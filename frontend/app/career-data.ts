...
export const CAREERS: Career[] = [
  {
    ...
    team: '소속사 투입 7명 중 디지털돌봄 담당은 PL 1명과 개발자 본인.\n요구사항은 정보원 측 선임 2명이 전달',
    tasks: [
    ...
    proof: 'DDL·테이블정의서·화면정의서.\n이 사이트의 toolbox·docrules 는 이 업무의 산출물 작성용으로 제작',
  },
  {
    ...
    team: '팀 5명. 투입 기간에 다른 팀원은 제안서 작성 중으로 구현은 본인 담당.\nAOP 캐시 방식은 지시 사항, 적용 지점 선정과 구현은 본인 수행',
    tasks: [
  ...
  },
  {
    ...
    tasks: [
      '통합계정(그룹웨어) 기능 유지보수',
      'NoSQL·RDBMS 간 계정 동기화 장애 처리 —\n한쪽만 삭제된 계정을 양쪽 DB 대조 후 삭제 로직에 맞춰 정리',
    ],
    proof: '',
  },
  {
    ...
    team: '',
    tasks: [
      '월 단위 요금 배치 운영·모니터링 — 수천만 건 규모. 실패 건 원인 분석과 재처리',
