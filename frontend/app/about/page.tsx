...
const QA: QAItem[] = [
  {
    ...
    a: "대체로 업무는 인트라넷을 사용하는 폐쇄된 환경에서 이뤄졌기 때문에\n" +
        "최대한 많은 개발도구, 플러그인들을 설치한 뒤 폐쇄망으로 전환하여 업무를 진행합니다.\n" +
        "AI 이전에는 구글 검색으로 문서를 뒤져가며 해결방안을 찾아다녔지만\n" +
        "AI 이후에는 기술적인 문제보다는 설계자의 입장에서 해당 기능에 대해 어떤 불편을 겪는지에 초점을 두고\n" +
        "최대한 많은 방안을 생각해본 뒤, 어떤 방안을 선택할지 논의하는 식으로 처리합니다.\n" +
        "메모하는 습관이 있어서 업무 중 발견한 이슈나 방법, 아이디어를 기록해두고 활용합니다.\n" +
  ...
  },
  {
    ...
    a: "개발자들의 일자리에 큰 변화가 생겼다는 통계가 있는데\n" +
        "이를 보면 현 상황에 적응하지 못한 초급 개발자는 하락세,\n" +
        "경력이 높은 개발자들은 오히려 상승세를 타고 있습니다.\n" +
        "어떻게 적응하느냐가 쟁점이며,\n" +
        "그렇기에 목적에 맞게 AI를 활용하여 설계, 개발, 학습 등 목적을 구분해서 활용하고 있습니다.\n" +
        "AI는 빅데이터를 기반으로 수많은 답을 펼쳐놓는 발산형 도구입니다.\n" +
        "반면 인간은 현실의 제약과 맥락을 파악하며 하나로 수렴시킬 수 있습니다.\n" +
        "우리에게 필요한 것은 펼쳐진 답 중에서 현실에 맞는 선택을 하는 안목입니다.\n"+
        "(job-stat)",
    details: [
      {
        id: "job-stat",
  ...
  },
  {
    ...
    a: "지속가능한 삶을 유지하고 싶어 규칙적으로 생활하고 있습니다.\n" +
       "운동, 식습관, 수면 등 검증된 방법을 찾아 적용하며 유지 중입니다.\n" +
        "업무 중 모르는 부분을 메모하여 집에서 따로 검색해보곤 합니다.\n" +
       "또한 중요하거나 기억해두고 싶은 부분은 OneNote에 분류하여 저장합니다.\n" +
       "안목을 넓히는 것도 중요하므로 개발 외의 분야도 두루 보는 편입니다.\n"+
       "(what-i-doing)[OneNote](https://1drv.ms/o/c/b4b739c9b74f33c1/IgDBM0-3yTm3IIC0_wkAAAAAAb5TVeK0tvtY6CTewEFH038?e=UT6Rlx)",
    details: [
      {
        id: "what-i-doing",
        label: "일일 기준 루틴",
  ...
  },
  {
    ...
    a: "최근에 사회보장원에서 했던 프로젝트가 가장 기억에 남습니다.\n" +
    "요구사항이 제대로 설계되어 있지 않아서 전반에 걸쳐 개입하게 되었습니다.\n" +
    "레거시 코드를 보고 구상한 설계로 의견을 냈는데\n" +
        "그 때마다 방향성이 좋아보인다며 대부분 제 의견대로 돌아갔습니다.\n" +
        "발주처의 개발자분이나 선임분도 좋게 평가해주셨고\n" +
        "의견이 활발하게 오갈 수 있어 문제를 파악하는게 수월했습니다.\n" +
        "그 외에 외적인 스트레스 요소가 없었고\n" +
        "밀도 높은 집중력으로 업무가 진행되어 고양감을 느꼈습니다.\n" +
        "(problem)",
    details: [
      {
        id: "problem",
        ...
        content:
            ...
            "2)주석, 코드에 통일성이 없고 명칭 표기법이 섞여있음\n" +
            "->네이밍 규칙 등을 일관성있게 정리,\n" +
            "주요 구간을 중심으로 리팩토링 진행\n\n" +
            "3)impl에 들어갈 코드가 controller에 들어감\n" +
            "->역할에 맞게 코드를 적절한 계층으로 이동시키고\n" +
            "controller는 요청/응답 처리만 담당하도록 변경\n\n" +
            "4)요구사항 정의서에 화면명이 적혀있지않음\n" +
            "->개발자와 직접 대화하여 요구사항 정리 및 문서화\n\n" +
            "5)개발용 API가 없어서 테스트가 불가능한 상태\n" +
            "->개발용 API는 없다고 하여 그대로 개발\n"
      }
    ]
  },
]
