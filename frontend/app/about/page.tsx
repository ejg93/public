...
const QA: QAItem[] = [
  ...
  },
  {
    ...
    a: "개발자들의 일자리에 큰 변화가 생겼다는 통계가 있는데\n" +
        ...
        "어떻게 적응하느냐가 쟁점이며.\n" +
        "그렇기에 목적에 맞게 AI 활용하여 설계, 개발, 학습 등 목적을 구분해서 활용하고 있다.\n" +
        "AI는 빅데이터를 기반으로 수많은 답을 펼쳐놓는 발산형 도구다.\n" +
        "반면 인간은 현실의 제약과 맥락을 파악하며 하나로 수렴시킬 수 있다.\n" +
        "우리에게 필요한 것은 펼쳐진 답 중에서 현실에 맞는 선택을 하는 안목이다.\n"+
        "(job-stat)",
    details: [
      {
        id: "job-stat",
  ...
  },
  {
    ...
    a: "지속가능한 삶을 유지하고 싶어 규칙적으로 생활하고 있다.\n" +
       "운동, 식습관, 수면 등 검증된 방법을 찾아 적용하며 유지 중이다.\n" +
        "업무 중 모르는 부분을 메모하여 집에서 따로 검색해보곤 한다.\n" +
       "또한 중요하거나 기억해두고 싶은 부분은 OneNote에 분류하여 저장한다.\n" +
       "안목을 넓히는 것도 중요하므로 개발 외의 분야도 두루 보는 편이다.\n"+
  ...
  },
  {
    ...
    a: "최근에 사회보장원에서 했던 프로젝트가 가장 기억에 남았다.\n" +
    "요구사항이 제대로 설계되어 있지 않아서 전반에 걸쳐 개입하게 되었다.\n" +
    "레거시 코드를 보고 구상한 설계로 의견을 냈는데\n" +
        "그 때마다 방향성이 좋아보인다며 대부분 내 의견대로 돌아갔다.\n" +
        "발주처의 개발자분이나 선임분도 좋게 평가해주셨고\n" +
        "의견이 활발하게 오갈 수 있어 문제를 파악하는게 수월했다.\n" +
        "그 외에 외적인 스트레스 요소가 없어서\n" +
        "밀도 높은 집중력으로 업무가 진행되서 기분이 좋았다\n" +
        "(problem)",
    details: [
      {
        id: "problem",
